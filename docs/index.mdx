...
Read these in order when setting up a maker:

1. [Quickstart](/quickstart) to run the local API and web app.
2. [Maker setup](/maker-setup) to configure live credentials, policy, inventory, and safety caps.
3. [Swap flow](/swap-flow) to understand the app-facing RFQ and wallet-settlement path.
4. [Runtime proof](/runtime-proof) to inspect public state, events, ledger, and trades.
