//! Solana RPC, balance-read, and associated-token-account scaffolding.
...
use crate::assets::{AssetError, AssetMetadata, AssetRegistry};
use crate::error::AppError;
use crate::ports::BalanceReader;
use crate::types::{AmountRaw, BalanceSnapshot, TokenAmount, WalletRole};
...
mod tests {
    ...
    use super::*;
    use crate::assets::{AssetRegistry, USDC_MINT};
    use crate::config::{SolanaConfig, WalletsConfig};
    use crate::types::AssetId;
    use crate::wallets::LoadedWallet;
    ...
    fn solana_client_derives_legacy_token_ata() {
        ...
        let wallet =
            LoadedWallet::from_json(crate::types::WalletRole::Maker, &keypair_json).unwrap();
