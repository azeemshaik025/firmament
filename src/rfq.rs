...
use crate::events::{EventMetadata, QuoteEvent, RiskEvent, RuntimeEvent};
...
use crate::risk::{RiskEvaluationInput, RiskPolicy, evaluate_pre_quote};
use crate::types::{
    ...
    pub fn from_config(config: &AppConfig, inventory: InventorySnapshot) -> Self {
        ...
        let risk_policy = RiskPolicy {
            ...
            native_sol_gas_buffer_raw: config
                ...
                .unwrap_or_default(),
            asset_usd_prices: vec![(crate::types::AssetId::from("USDC"), Decimal::ONE)],
        };
